...
declare namespace apksUtilsMethods {
     ...
     * executing it
     */
    function execBundletool(this: import("../adb.js").ADB, args: string[], errorMsg: string): Promise<string>;
    /**
     *
     * @this {import('../adb.js').ADB}
     ...
     */
    function installMultipleApks(this: import("../adb.js").ADB, apkPathsToInstall: string[], options?: InstallMultipleApksOptions | undefined): Promise<string>;
    /**
     ...
     */
    function installApks(this: import("../adb.js").ADB, apks: string, options?: InstallApksOptions | undefined): Promise<void>;
    /**
     ...
     * @throws {Error} If there was an error while extracting/finding the file
     */
    function extractLanguageApk(this: import("../adb.js").ADB, apks: string, language?: string | null | undefined): Promise<string>;
    /**
     *
     * @param {string} output
     * @returns {boolean}
