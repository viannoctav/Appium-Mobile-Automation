...
declare namespace emuMethods {
     ...
     */
    function sensorSet(this: import("../adb.js").ADB, sensor: string, value: import("type-fest").ValueOf<Readonly<{
        ACCELERATION: "acceleration";
        GYROSCOPE: "gyroscope";
        MAGNETIC_FIELD: "magnetic-field";
        ORIENTATION: "orientation";
     ...
     */
    function gsmCall(this: import("../adb.js").ADB, phoneNumber: string | number, action: import("type-fest").ValueOf<Readonly<{
        GSM_CALL: "call";
        GSM_ACCEPT: "accept";
        GSM_CANCEL: "cancel";
        GSM_HOLD: "hold";
     ...
     *   target=android-30
     */
    function getEmuImageProperties(this: import("../adb.js").ADB, avdName: string): Promise<import("@appium/types").StringRecord<any>>;
    /**
